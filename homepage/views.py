...
def index(request):
    ...
    return render(request, 'epsilonIndex.html', {"home": True , "brandLogo" : globalSettings.BRAND_LOGO , "brandLogoInverted": globalSettings.BRAND_LOGO_INVERT,"erpUrl": globalSettings.ERP_URL_PREFIX,'apiManagerUrl':globalSettings.APIMANAGER_URL_PREFIX})
