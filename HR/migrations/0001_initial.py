...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='organization.Departments')),
                ('division', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='organization.Division')),
                ...
                ('role', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='organization.Role')),
                ...
                ('unit', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='organization.Unit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[(b'inProcess', b'inProcess'), (b'approved', b'approved'), (b'rejected', b'rejected')], default=b'inProcess', max_length=100)),
