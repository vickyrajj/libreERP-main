...
class userProfileLiteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = profile
        fields = ('displayPicture' , 'prefix' ,'primaryAddress','details')
...
class userSearchSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ( 'pk', 'username' , 'first_name' , 'last_name' , 'profile' , 'social' , 'designation','is_staff' )
...
class userSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('pk' , 'username' , 'email' , 'first_name' , 'last_name' , 'designation' ,'profile'  ,'settings' , 'password' , 'social', 'payroll', 'is_active','is_staff')
        read_only_fields = ('designation' , 'profile' , 'settings' ,'social', 'payroll','is_staff' )
